...
export const SUI_COIN_DECIMALS = 9;
...
export const suiFaucet = async () => {
    return execSync(`${SUI_BIN} client faucet`, {
        encoding: "utf8",
    }).trim();
};

export const switchAddressByAlias = (alias: string): string => {
    return getAddressByAlias(alias);
};
